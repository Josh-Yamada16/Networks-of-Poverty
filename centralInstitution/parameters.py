...
PERCENTAGE_OF_INFECTED_NODES = 0.2  # Percentage of nodes that are initially infected (between 0 and 1)
...
EXTRA_BLOCK_PROB_LOW = 0.5  # Probability of edges between blocks
EXTRA_BLOCK_PROB_HIGH = 0.15  # Probability of edges between blocks
...
SBM_HUB_LEAF_PROB = 0.7
SBM_HUB_HUB_PROB = 0.10
SBM_LEAF_LEAF_PROB = 0.03
SBM_INTER_BLOCK_PROB_SCALE = 0.1
