...
NUM_ITERATIONS = 100  # Number of iterations for the token exchange simulation
...
PERCENTAGE_OF_INFECTED_NODES = 0.15
...
NUM_NODES = 1000  # Number of nodes in the graph (matching your custom graph)
