...
from networkSim.utils import Utils as utils
...
def test_edge_matrix_is_row_stochastic():
    g, edge_mat, node_list = Setup.gen_graph(t="sto", n_nodes=10, seed=42)
...
def test_gen_multidirected_graph():
    n_nodes = 10
    G, edge_mat, node_list = Setup.gen_graph(t="dir", n_nodes=n_nodes, seed=123)
    # Check graph type
